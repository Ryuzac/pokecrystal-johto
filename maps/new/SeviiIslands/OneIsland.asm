...
CinnabarIsland_MapEvents:
	...
	def_warp_events
	warp_event -1,  1, CINNABAR_POKECENTER_1F, 1

	def_coord_events

	def_bg_events
	bg_event  0,  1, BGEVENT_READ, CinnabarIslandPokecenterSign
	bg_event -3,  1, BGEVENT_READ, CinnabarIslandGymSign
	bg_event -5, -3, BGEVENT_READ, CinnabarIslandSign
	bg_event -3, -6, BGEVENT_ITEM, CinnabarIslandHiddenRareCandy

	def_object_events
	object_event -3, -4, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
