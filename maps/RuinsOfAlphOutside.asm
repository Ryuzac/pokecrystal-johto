...
RuinsOfAlphOutside_MapEvents:
	...
	def_warp_events
	warp_event  2, 23, RUINS_OF_ALPH_HO_OH_CHAMBER, 1
	warp_event 16, 13, RUINS_OF_ALPH_KABUTO_CHAMBER, 1
	warp_event  2, 35, RUINS_OF_ALPH_OMANYTE_CHAMBER, 1
	warp_event 16, 39, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 1
	warp_event 12, 19, RUINS_OF_ALPH_ENTRY_ROOM, 1
	warp_event 19, 17, RUINS_OF_ALPH_RESEARCH_CENTER, 1
	warp_event  6, 25, UNION_CAVE_B1F, 1
	warp_event  6, 33, UNION_CAVE_B1F, 2
	...
	coord_event 12, 21, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene2

	def_bg_events
	bg_event 18, 14, BGEVENT_READ, RuinsOfAlphOutsideMysteryChamberSign
	bg_event 14, 22, BGEVENT_READ, RuinsOfAlphSign
	bg_event 20, 18, BGEVENT_READ, RuinsOfAlphResearchCenterSign

	def_object_events
	object_event  4, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
	object_event 13, 21, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_RUINS_OF_ALPH_OUTSIDE_SCIENTIST
	...
	object_event 16, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster1Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
	object_event 14, 14, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster2Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
