...
CherrygroveRivalSceneSouth:
	moveobject CHERRYGROVECITY_RIVAL, 43, 7
...
CherrygroveCity_MapEvents:
	...
	def_warp_events
	warp_event 27,  3, CHERRYGROVE_MART, 2
	warp_event 33,  3, CHERRYGROVE_POKECENTER_1F, 1
	warp_event 21,  7, CHERRYGROVE_GYM_SPEECH_HOUSE, 1
	warp_event 29,  9, GUIDE_GENTS_HOUSE, 1
	warp_event 35, 11, CHERRYGROVE_EVOLUTION_SPEECH_HOUSE, 1

	def_coord_events
	coord_event 37,  6, SCENE_CHERRYGROVECITY_MEET_RIVAL, CherrygroveRivalSceneNorth
	coord_event 37,  7, SCENE_CHERRYGROVECITY_MEET_RIVAL, CherrygroveRivalSceneSouth

	def_bg_events
	bg_event 34,  8, BGEVENT_READ, CherrygroveCitySign
	bg_event 27,  9, BGEVENT_READ, GuideGentsHouseSign
	bg_event 28,  3, BGEVENT_READ, CherrygroveCityMartSign
	bg_event 34,  3, BGEVENT_READ, CherrygroveCityPokecenterSign

	def_object_events
	object_event 36,  6, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CherrygroveCityGuideGent, EVENT_GUIDE_GENT_IN_HIS_HOUSE
	object_event 43,  6, SPRITE_RIVAL, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RIVAL_CHERRYGROVE_CITY
	object_event 31, 12, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CherrygroveTeacherScript, -1
	object_event 27,  7, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CherrygroveYoungsterScript, -1
	object_event 11, 12, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, MysticWaterGuy, -1
