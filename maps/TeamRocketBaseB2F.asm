...
RocketBaseBossFScript:
	...
	applymovement FOLLOWER, RocketBaseFollowerMoveBoss
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  3, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_ITEMBALL, 0, TeamRocketBaseB2FTMThief, EVENT_TEAM_ROCKET_BASE_B2F_TM_THIEF
