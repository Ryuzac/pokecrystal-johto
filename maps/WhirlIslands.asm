	object_const_def
	const WHIRL_ISLANDS_OLIVINE_RIVAL1
	const WHIRL_ISLANDS_OLIVINE_RIVAL2
	const WHIRL_ISLANDS_OLIVINE_RIVAL3
	const WHIRL_ISLANDS_OLIVINE_RIVAL4
	const WHIRL_ISLANDS_OLIVINE_RIVAL5
	const WHIRL_ISLANDS_SWIMMER_GIRL1
	const WHIRL_ISLANDS_SWIMMER_GIRL2
	const WHIRL_ISLANDS_SWIMMER_GIRL3
	const WHIRL_ISLANDS_SWIMMER_GIRL4
	const WHIRL_ISLANDS_SWIMMER_GIRL5

WhirlIslands_MapScripts:
	def_scene_scripts
