...
FalknerGroup:
	...
	db  9, NATU,   	   NO_ITEM,		PECK, LEER, NO_MOVE, NO_MOVE
	db 13, NOCTOWL,    BERRY,		TACKLE, MUD_SLAP, PECK, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 18, JIGGLYPUFF, NO_ITEM,		DOUBLESLAP, MIMIC, CHARM, DEFENSE_CURL
...
PryceGroup:
	...
	db 27, SEEL,       NO_ITEM,		HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 29, DEWGONG,    NO_ITEM,		HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 31, PILOSWINE,  GOLD_BERRY,	ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  NO_ITEM,		THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, STEELIX,    GOLD_BERRY,	SCREECH, SANDSTORM, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 27, PRIMEAPE,   NO_ITEM,	LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 30, POLIWRATH,  GOLD_BERRY,	HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 37, DRAGONAIR,  NO_ITEM,		THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
