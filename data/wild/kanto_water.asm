...
KantoWaterWildMons:
	...
	;   %, species,    min, max
	db 60, GOLDEEN,		20, 24
	db 20, SLOWPOKE,	20, 24
	db 10, SLOWPOKE,	20, 24
	db 10, SEAKING,		20, 24
	end_water_wildmons
	...
	;   %, species,    min, max
	db 60, TENTACOOL,	30, 39
	db 20, TENTACOOL,	30, 39
	db 10, TENTACOOL,	30, 39
	db 10, TENTACRUEL,	35, 39
	end_water_wildmons
	...
	;   %, species,    min, max
	db 60, TENTACOOL,	25, 29
	db 20, QUAGSIRE,	25, 29
	db 10, QUAGSIRE,	25, 29
	db 10, TENTACRUEL,	25, 29
	end_water_wildmons
	...
	db 6 percent ; encounter rate
	;   %, species,    min, max
	db 60, TENTACOOL,	25, 34
	db 20, TENTACOOL,	25, 34
	db 10, TENTACOOL,	25, 34
	db 10, TENTACRUEL,	30, 34
	end_water_wildmons
