...
JohtoWaterWildMons:
	...
	;  %, species,     min, max
	db 60, WOOPER, 		15, 19
	db 20, QUAGSIRE, 	15, 24
	db 15, QUAGSIRE, 	15, 24
	db  5, QUAGSIRE, 	15, 24
	end_water_wildmons
	...
	db 20, QUAGSIRE,	20, 24
	db  5, QUAGSIRE,	20, 24
	db 15, TENTACRUEL,	20, 24
	end_water_wildmons

	def_water_wildmons SLOWPOKE_WELL_B1F
	db 2 percent ; encounter rate
	;  %, species,     min, max
	db 60, SLOWPOKE, 	10, 24
	db 20, SLOWPOKE, 	10, 24
	db 15, SLOWPOKE, 	10, 24
	db  5, SLOWPOKE, 	10, 24
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, SLOWPOKE, 	15, 19
	db 20, SLOWPOKE, 	15, 19
	db 10, SLOWPOKE, 	15, 19
	db 10, SLOWBRO, 	20, 24
	end_water_wildmons
	...
	db 4 percent ; encounter rate
	;  %, species,    min, max
	db 60, MAGIKARP,	10, 19
	db 20, MAGIKARP,	10, 19
	db 10, MAGIKARP,	10, 19
	db 10, DRATINI,		10, 14
	end_water_wildmons
	...
	db 20, TENTACOOL,	15, 24
	db 10, TENTACOOL,	15, 24
	db 10, TENTACRUEL,	20, 24
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, MAGIKARP,	10, 24
	db 20, MAGIKARP,	10, 24
	db 10, MAGIKARP,	10, 24
	db 10, MAGIKARP,	10, 24
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	;  %, species,    min, max
	db 60, POLIWHIRL,	35, 44
	db 20, POLIWAG,		35, 39
	db 10, POLIWAG,		35, 39
	db 10, POLIWHIRL,	35, 44
	end_water_wildmons
