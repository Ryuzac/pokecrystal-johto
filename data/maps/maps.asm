...
MapGroup_SafariZone:
	...
	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CliffEdgeGate, TILESET_CAVE, CAVE, LANDMARK_CLIFF_EDGE_GATE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CliffCave, TILESET_CAVE, CAVE, LANDMARK_CLIFF_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map SafariZoneGate, TILESET_JOHTO, TOWN, LANDMARK_SAFARI_ZONE_GATE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
