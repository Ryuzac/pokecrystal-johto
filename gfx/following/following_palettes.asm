...
DEF PAL_MEWMON    EQU PAL_OW_PURPLE
DEF PAL_GREENMON  EQU PAL_OW_GREEN
DEF PAL_CYANMON   EQU PAL_OW_BLUE
DEF PAL_REDMON    EQU PAL_OW_RED
DEF PAL_YELLOWMON EQU PAL_OW_RED
DEF PAL_BROWNMON  EQU PAL_OW_BROWN
DEF PAL_GREYMON   EQU PAL_OW_BROWN
DEF PAL_BLUEMON   EQU PAL_OW_BLUE
DEF PAL_PURPLEMON EQU PAL_OW_PURPLE
DEF PAL_PINKMON   EQU PAL_OW_RED

FollowingPalettes::
	table_width 1, FollowingPalettes
