	...
	tilepal 0, ROOF, RED, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, GRAY, GRAY, BROWN, BROWN, BROWN, ROOF, ROOF, ROOF
	tilepal 0, RED, RED, GREEN, GREEN, BROWN, BROWN, BROWN, TEXT
	...
	tilepal 1, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, GRAY, BROWN
