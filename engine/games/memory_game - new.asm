...
.LoadGFXAndPals:
	...
	ld b, SCGB_DIPLOMA
	call GetSGBLayout
	callfar ClearSpriteAnims ; callab InitEffectObject
	ld hl, MemoryGameLZ
	ld de, vTiles2 tile $00
	call Decompress
	ld hl, MemoryGameGFX
	ld de, vTiles0 tile $00 ;vChars2
	ld bc, 4 tiles
	...
	ldh [rLCDC], a
	ld a, $e4		 	 ; %11100100
	call DmgToCgbBGPals  ; ldh [rBGP], a
	ld a, $e0		     ; %11100000
	call DmgToCgbObjPal0 ; ldh [rOBP0], a
	ret
...
.JumptableLoop:
	...
	callfar PlaySpriteAnimations ; callab EffectObjectJumpNoDelay
	call DelayFrame
	and a
	ret
...
.ResetBoard:
	...
	jr nc, .proceed
	ld hl, wJumptableIndex
	set MEMORYGAME_END_LOOP_F, [hl] ; 7
	ret
...
.PickAgain:
	...
	ld a, MEMORYGAME_CHECK_TRIES_REMAINING ; $3
	ld [wJumptableIndex], a
	ret
