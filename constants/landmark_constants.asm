...
; Johto landmarks
	...
	const LANDMARK_CLIFF_EDGE_GATE	 ; 23
	const LANDMARK_ROUTE_47			 ; 24
	const LANDMARK_CLIFF_CAVE		 ; 25
	const LANDMARK_EMBEDDED_TOWER	 ; 26
	const LANDMARK_ROUTE_48			 ; 27
	const LANDMARK_SAFARI_ZONE_GATE	 ; 28
